...
print("Creating secondary index for distributorpartnumber...")

query = f"CREATE INDEX idx_distributorpartnumber ON `{bucket_name}` (UPPER(TO_STRING(distributorpartnumber)))"
